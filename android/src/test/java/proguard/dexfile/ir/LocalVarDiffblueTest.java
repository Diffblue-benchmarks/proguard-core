...
class LocalVarDiffblueTest {
  ...
  @MethodsUnderTest({
    "void proguard.dexfile.ir.LocalVar.<init>(java.lang.String, java.lang.String, java.lang.String, proguard.dexfile.ir.stmt.LabelStmt, proguard.dexfile.ir.stmt.LabelStmt, proguard.dexfile.ir.expr.Local)",
    "java.lang.String proguard.dexfile.ir.LocalVar.toString()"
  })
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
    "proguard.dexfile.ir.LocalVar proguard.dexfile.ir.LocalVar.clone(proguard.dexfile.ir.LabelAndLocalMapper)"
  })

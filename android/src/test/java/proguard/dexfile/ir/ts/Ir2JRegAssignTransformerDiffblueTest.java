...
public class Ir2JRegAssignTransformerDiffblueTest {
  ...
  public void testGroupAndCleanUpByType_givenRegTypeIsStartOfHeading_thenReturnASizeIsOne() {
    // Arrange
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"Map Ir2JRegAssignTransformer.groupAndCleanUpByType(Reg[])"})
  public void testGroupAndCleanUpByType_givenRegTypeIsStartOfHeading_thenReturnASizeIsOne2() {
    // Arrange
    Ir2JRegAssignTransformer ir2JRegAssignTransformer = new Ir2JRegAssignTransformer();
    Reg reg = new Reg();
    reg.excludes = new HashSet<>();
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"Map Ir2JRegAssignTransformer.groupAndCleanUpByType(Reg[])"})
  public void testGroupAndCleanUpByType_whenArrayOfRegWithReg_thenReturnASizeIsOne() {
    // Arrange
    Ir2JRegAssignTransformer ir2JRegAssignTransformer = new Ir2JRegAssignTransformer();
    Reg reg = new Reg();
    reg.excludes = new HashSet<>();

...
class StmtTravelerDiffblueTest {
  ...
  @MethodsUnderTest({
    "proguard.dexfile.ir.expr.Value proguard.dexfile.ir.StmtTraveler.travel(proguard.dexfile.ir.expr.Value)"
  })
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
    "proguard.dexfile.ir.stmt.Stmt proguard.dexfile.ir.StmtTraveler.travel(proguard.dexfile.ir.stmt.Stmt)"
  })

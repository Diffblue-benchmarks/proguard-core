...
class TypeClassDiffblueTest {
  ...
  @MethodsUnderTest({
    "proguard.dexfile.ir.TypeClass proguard.dexfile.ir.TypeClass.clzOf(java.lang.String)"
  })
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
    "proguard.dexfile.ir.TypeClass proguard.dexfile.ir.TypeClass.merge(proguard.dexfile.ir.TypeClass, proguard.dexfile.ir.TypeClass)"
  })
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"java.lang.String proguard.dexfile.ir.TypeClass.toString()"})
  void testToString() {
    // Arrange, Act and Assert

...
class FilledNewArrayStmtNodeDiffblueTest {
  ...
  @MethodsUnderTest({
    "void proguard.dexfile.reader.node.insn.FilledNewArrayStmtNode.<init>(proguard.dexfile.reader.Op, int[], java.lang.String)"
  })
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
    "void proguard.dexfile.reader.node.insn.FilledNewArrayStmtNode.accept(proguard.dexfile.reader.visitors.DexCodeVisitor)"
  })

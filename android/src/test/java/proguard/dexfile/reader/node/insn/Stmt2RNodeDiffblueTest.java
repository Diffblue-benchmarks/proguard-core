...
class Stmt2RNodeDiffblueTest {
  ...
  @MethodsUnderTest({
    "void proguard.dexfile.reader.node.insn.Stmt2RNode.<init>(proguard.dexfile.reader.Op, int, int)"
  })
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
    "void proguard.dexfile.reader.node.insn.Stmt2RNode.accept(proguard.dexfile.reader.visitors.DexCodeVisitor)"
  })

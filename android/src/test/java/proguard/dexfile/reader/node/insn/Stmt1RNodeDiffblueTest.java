...
class Stmt1RNodeDiffblueTest {
  ...
  @MethodsUnderTest({
    "void proguard.dexfile.reader.node.insn.Stmt1RNode.<init>(proguard.dexfile.reader.Op, int)"
  })
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
    "void proguard.dexfile.reader.node.insn.Stmt1RNode.accept(proguard.dexfile.reader.visitors.DexCodeVisitor)"
  })

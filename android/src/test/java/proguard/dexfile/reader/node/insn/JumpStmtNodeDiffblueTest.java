...
class JumpStmtNodeDiffblueTest {
  ...
  @MethodsUnderTest({
    "void proguard.dexfile.reader.node.insn.JumpStmtNode.<init>(proguard.dexfile.reader.Op, int, int, proguard.dexfile.reader.DexLabel)"
  })
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
    "void proguard.dexfile.reader.node.insn.JumpStmtNode.accept(proguard.dexfile.reader.visitors.DexCodeVisitor)"
  })

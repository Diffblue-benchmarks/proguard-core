...
public class DexMethodNodeDiffblueTest {
  /**
   * Method under test: {@link DexMethodNode#accept(DexClassVisitor)}
   */
  @Test
  ...
  /**
   * Method under test: {@link DexMethodNode#visitAnnotation(String, Visibility)}
   */
  @Test
  public void testVisitAnnotation() {
    // Arrange
    DexMethodNode dexMethodNode = new DexMethodNode(1,
        new Method("Owner", "Name", new Proto(new String[]{"Parameter Types"}, "Return Type")));

    // Act
    DexAnnotationVisitor actualVisitAnnotationResult = dexMethodNode.visitAnnotation("Name", Visibility.BUILD);
  ...
  /**
   * Method under test: {@link DexMethodNode#visitCode()}
   */
  @Test
  ...
  public void testVisitCode2() {
    ...
    DexMethodNode dexMethodNode = new DexMethodNode(mv, -1,
        new Method("Owner", "Name", new Proto(new String[]{"Parameter Types"}, "Return Type")));
  ...
  /**
   * Method under test: {@link DexMethodNode#visitParameterAnnotation(int)}
   */
  @Test
  public void testVisitParameterAnnotation() {
    ...
    // Act
    DexAnnotationVisitor actualVisitAnnotationResult = dexMethodNode.visitParameterAnnotation(1)
        .visitAnnotation("foo", Visibility.BUILD);
    ...
    List<DexAnnotationNode.Item> itemList = getResult.items;
    assertTrue(itemList.isEmpty());
    assertSame(getResult, actualVisitAnnotationResult);
    assertSame(((DexAnnotationNode) actualVisitAnnotationResult).items, itemList);
  }

  /**
   * Method under test: {@link DexMethodNode#DexMethodNode(int, Method)}
   */
  @Test
  public void testNewDexMethodNode() {
    // Arrange
    Proto proto = new Proto(new String[]{"Parameter Types"}, "Return Type");
  ...
  /**
   * Method under test:
   * {@link DexMethodNode#DexMethodNode(DexMethodVisitor, int, Method)}
   */
  @Test
  public void testNewDexMethodNode2() {
    // Arrange
    DexMethodVisitor mv = new DexMethodVisitor();
    Proto proto = new Proto(new String[]{"Parameter Types"}, "Return Type");

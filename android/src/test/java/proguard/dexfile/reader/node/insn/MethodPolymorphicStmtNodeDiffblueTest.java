...
class MethodPolymorphicStmtNodeDiffblueTest {
  ...
  @MethodsUnderTest({
    "void proguard.dexfile.reader.node.insn.MethodPolymorphicStmtNode.<init>(proguard.dexfile.reader.Op, int[], proguard.dexfile.reader.Method, proguard.dexfile.reader.Proto)",
    "proguard.dexfile.reader.Proto proguard.dexfile.reader.node.insn.MethodPolymorphicStmtNode.getProto()"
  })
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
    "void proguard.dexfile.reader.node.insn.MethodPolymorphicStmtNode.accept(proguard.dexfile.reader.visitors.DexCodeVisitor)"
  })

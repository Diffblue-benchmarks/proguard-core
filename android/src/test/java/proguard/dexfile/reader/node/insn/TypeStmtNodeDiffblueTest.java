...
class TypeStmtNodeDiffblueTest {
  ...
  @MethodsUnderTest({
    "void proguard.dexfile.reader.node.insn.TypeStmtNode.<init>(proguard.dexfile.reader.Op, int, int, java.lang.String)"
  })
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
    "void proguard.dexfile.reader.node.insn.TypeStmtNode.accept(proguard.dexfile.reader.visitors.DexCodeVisitor)"
  })

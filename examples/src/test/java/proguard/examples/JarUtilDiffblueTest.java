...
public class JarUtilDiffblueTest {
  ...
  @MethodsUnderTest({
    "proguard.classfile.ClassPool proguard.examples.JarUtil.readJar(java.lang.String, java.lang.String, boolean)"
  })
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
    "proguard.classfile.ClassPool proguard.examples.JarUtil.readJar(java.lang.String, boolean)"
  })
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
    "void proguard.examples.JarUtil.writeJar(proguard.classfile.ClassPool, java.lang.String)"
  })
  public void testWriteJar_givenLibraryClassAcceptDoesNothing_thenCallsAccept() throws IOException {
    ...
    ClassPool programClassPool = JarUtil.readJar("foo.txt", "Class Name Filter", true);

...
class DataEntryClassInfoFilterDiffblueTest {
   ...
   *
   * <ul>
   *   <li>When {@link FileDataEntry#FileDataEntry(File)} with file is Property is {@code
  ...
  @Test
  @DisplayName(
      "Test accepts(DataEntry); when FileDataEntry(File) with file is Property is 'java.io.tmpdir' is 'test.txt' toFile")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean DataEntryClassInfoFilter.accepts(DataEntry)"})
  void testAccepts_whenFileDataEntryWithFileIsPropertyIsJavaIoTmpdirIsTestTxtToFile() {
    // Arrange
    DataEntryClassInfoFilter dataEntryClassInfoFilter =
        new DataEntryClassInfoFilter(KotlinConstants.dummyClassPool, "Processing Info");
    ...
    // Act
    boolean actualAcceptsResult =
        dataEntryClassInfoFilter.accepts(
            new FileDataEntry(

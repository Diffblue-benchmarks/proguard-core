...
class BlockAbstractionDiffblueTest {
  ...
  @MethodsUnderTest({
    "void proguard.analysis.cpa.bam.BlockAbstraction.<init>(proguard.analysis.cpa.interfaces.ReachedSet, proguard.analysis.cpa.interfaces.Waitlist)",
    "proguard.analysis.cpa.interfaces.ReachedSet proguard.analysis.cpa.bam.BlockAbstraction.getReachedSet()",
    "proguard.analysis.cpa.interfaces.Waitlist proguard.analysis.cpa.bam.BlockAbstraction.getWaitlist()"
  })

...
class JvmLocalVariableLocationDiffblueTest {
  ...
  @MethodsUnderTest({
    "void proguard.analysis.cpa.jvm.witness.JvmLocalVariableLocation.<init>(int)",
    "java.lang.String proguard.analysis.cpa.jvm.witness.JvmLocalVariableLocation.toString()"
  })
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
    "proguard.analysis.cpa.defaults.LatticeAbstractState proguard.analysis.cpa.jvm.witness.JvmLocalVariableLocation.extractValueOrDefault(proguard.analysis.cpa.jvm.state.JvmAbstractState, proguard.analysis.cpa.defaults.LatticeAbstractState)"
  })
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
    "boolean proguard.analysis.cpa.jvm.witness.JvmLocalVariableLocation.equals(java.lang.Object)",
    "int proguard.analysis.cpa.jvm.witness.JvmLocalVariableLocation.hashCode()"
  })

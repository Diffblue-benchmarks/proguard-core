...
class JvmStackLocationDiffblueTest {
  ...
  @MethodsUnderTest({
    "void proguard.analysis.cpa.jvm.witness.JvmStackLocation.<init>(int)",
    "int proguard.analysis.cpa.jvm.witness.JvmStackLocation.getIndex()",
    "java.lang.String proguard.analysis.cpa.jvm.witness.JvmStackLocation.toString()"
  })
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
    "proguard.analysis.cpa.defaults.LatticeAbstractState proguard.analysis.cpa.jvm.witness.JvmStackLocation.extractValueOrDefault(proguard.analysis.cpa.jvm.state.JvmAbstractState, proguard.analysis.cpa.defaults.LatticeAbstractState)"
  })
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
    "boolean proguard.analysis.cpa.jvm.witness.JvmStackLocation.equals(java.lang.Object)",
    "int proguard.analysis.cpa.jvm.witness.JvmStackLocation.hashCode()"
  })

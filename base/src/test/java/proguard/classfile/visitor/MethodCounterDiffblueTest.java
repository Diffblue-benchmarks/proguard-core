...
class MethodCounterDiffblueTest {
  ...
  @MethodsUnderTest({
    "void proguard.classfile.visitor.MethodCounter.visitProgramMethod(proguard.classfile.ProgramClass, proguard.classfile.ProgramMethod)"
  })
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
    "void proguard.classfile.visitor.MethodCounter.<init>()",
    "int proguard.classfile.visitor.MethodCounter.getCount()",
    "void proguard.classfile.visitor.MethodCounter.visitAnyMember(proguard.classfile.Clazz, proguard.classfile.Member)"
  })

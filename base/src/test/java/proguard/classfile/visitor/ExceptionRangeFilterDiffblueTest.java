...
class ExceptionRangeFilterDiffblueTest {
  /**
   * Test {@link ExceptionRangeFilter#visitExceptionInfo(Clazz, Method, CodeAttribute,
   * ExceptionInfo)}.
   *
   * <ul>
   ...
   * </ul>
   *
   * <p>Method under test: {@link ExceptionRangeFilter#visitExceptionInfo(Clazz, Method,
  ...
  @MethodsUnderTest({
    "void proguard.classfile.visitor.ExceptionRangeFilter.visitExceptionInfo(proguard.classfile.Clazz, proguard.classfile.Method, proguard.classfile.attribute.CodeAttribute, proguard.classfile.attribute.ExceptionInfo)"
  })
  void testVisitExceptionInfo_thenCallsVisitExceptionInfo() {
    ...
    ExceptionRangeFilter exceptionRangeFilter =
        new ExceptionRangeFilter(1, 3, exceptionInfoVisitor);
    ...
    // Act
    exceptionRangeFilter.visitExceptionInfo(

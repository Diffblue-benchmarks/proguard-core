...
class MemberAccessFlagSetterDiffblueTest {
  ...
  @MethodsUnderTest({
    "void proguard.classfile.visitor.MemberAccessFlagSetter.visitProgramField(proguard.classfile.ProgramClass, proguard.classfile.ProgramField)"
  })
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
    "void proguard.classfile.visitor.MemberAccessFlagSetter.visitProgramMethod(proguard.classfile.ProgramClass, proguard.classfile.ProgramMethod)"
  })

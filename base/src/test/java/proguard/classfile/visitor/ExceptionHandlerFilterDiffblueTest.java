...
class ExceptionHandlerFilterDiffblueTest {
  /**
   * Test {@link ExceptionHandlerFilter#visitExceptionInfo(Clazz, Method, CodeAttribute,
   * ExceptionInfo)}.
   *
   * <ul>
   ...
   * </ul>
   *
   * <p>Method under test: {@link ExceptionHandlerFilter#visitExceptionInfo(Clazz, Method,
  ...
  @MethodsUnderTest({
    "void proguard.classfile.visitor.ExceptionHandlerFilter.visitExceptionInfo(proguard.classfile.Clazz, proguard.classfile.Method, proguard.classfile.attribute.CodeAttribute, proguard.classfile.attribute.ExceptionInfo)"
  })
  void testVisitExceptionInfo_thenCallsVisitExceptionInfo() {
    ...
    ExceptionHandlerFilter exceptionHandlerFilter =
        new ExceptionHandlerFilter(1, 3, exceptionInfoVisitor);
    ...
    // Act
    exceptionHandlerFilter.visitExceptionInfo(

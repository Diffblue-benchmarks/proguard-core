...
class InstructionVisitorDiffblueTest {
  ...
  @MethodsUnderTest({
    "void proguard.classfile.instruction.visitor.InstructionVisitor.visitAnyInstruction(proguard.classfile.Clazz, proguard.classfile.Method, proguard.classfile.attribute.CodeAttribute, int, proguard.classfile.instruction.Instruction)"
  })

...
class ExternalTypeEnumerationDiffblueTest {
  ...
  @MethodsUnderTest({
    "void proguard.classfile.util.ExternalTypeEnumeration.<init>(java.lang.String)"
  })
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
    "void proguard.classfile.util.ExternalTypeEnumeration.setDescriptor(java.lang.String)"
  })

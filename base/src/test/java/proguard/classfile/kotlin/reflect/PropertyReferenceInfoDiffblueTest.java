...
public class PropertyReferenceInfoDiffblueTest {
  /**
   * Method under test: {@link PropertyReferenceInfo#getName()}
   */
  @Test
  public void testGetName() {
    ...
    KotlinPropertyMetadata propertyMetadata = new KotlinPropertyMetadata(flags, "Name", getterFlags,
        new KotlinPropertyAccessorFlags(visibility3, modality3));

    LibraryClass ownerClass = new LibraryClass();

    // Act and Assert
    assertEquals("Name", (new PropertyReferenceInfo(ownerClass,
        new KotlinClassKindMetadata(new int[]{1, -1, 1, -1}, 1, "Xs", "Pn"), propertyMetadata)).getName());
  }
   ...
   * <ul>
   *   <li>
   * {@link PropertyReferenceInfo#PropertyReferenceInfo(Clazz, KotlinDeclarationContainerMetadata, KotlinPropertyMetadata)}
  ...
  public void testGettersAndSetters() {
    ...
    // Act and Assert
    assertSame(ownerMetadata, (new PropertyReferenceInfo(ownerClass, ownerMetadata, new KotlinPropertyMetadata(flags,
        "Name", getterFlags, new KotlinPropertyAccessorFlags(visibility3, modality3)))).getOwner());
  }
}

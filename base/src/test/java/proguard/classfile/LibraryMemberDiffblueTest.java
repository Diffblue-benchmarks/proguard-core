...
class LibraryMemberDiffblueTest {
  ...
  @MethodsUnderTest({"int proguard.classfile.LibraryMember.getAccessFlags()"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
    "java.lang.String proguard.classfile.LibraryMember.getName(proguard.classfile.Clazz)"
  })
  void testGetName() {
    // Arrange
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
    "java.lang.String proguard.classfile.LibraryMember.getDescriptor(proguard.classfile.Clazz)"
  })

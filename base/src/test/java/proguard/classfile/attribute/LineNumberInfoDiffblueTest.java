...
class LineNumberInfoDiffblueTest {
  ...
  @MethodsUnderTest({
    "void proguard.classfile.attribute.LineNumberInfo.<init>()",
    "void proguard.classfile.attribute.LineNumberInfo.<init>(int, int)",
    "java.lang.String proguard.classfile.attribute.LineNumberInfo.getSource()"
  })

...
class FormalParameterTargetInfoDiffblueTest {
  ...
  @MethodsUnderTest({
    "void proguard.classfile.attribute.annotation.target.FormalParameterTargetInfo.<init>()",
    "void proguard.classfile.attribute.annotation.target.FormalParameterTargetInfo.<init>(byte)",
    "void proguard.classfile.attribute.annotation.target.FormalParameterTargetInfo.<init>(byte, int)"
  })

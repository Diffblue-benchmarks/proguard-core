...
class TargetInfoVisitorDiffblueTest {
  ...
  @MethodsUnderTest({
    "void proguard.classfile.attribute.annotation.target.visitor.TargetInfoVisitor.visitAnyTargetInfo(proguard.classfile.Clazz, proguard.classfile.attribute.annotation.TypeAnnotation, proguard.classfile.attribute.annotation.target.TargetInfo)"
  })

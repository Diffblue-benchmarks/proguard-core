...
class OffsetTargetInfoDiffblueTest {
  ...
  @MethodsUnderTest({
    "void proguard.classfile.attribute.annotation.target.OffsetTargetInfo.<init>()",
    "void proguard.classfile.attribute.annotation.target.OffsetTargetInfo.<init>(byte)",
    "void proguard.classfile.attribute.annotation.target.OffsetTargetInfo.<init>(byte, int)"
  })

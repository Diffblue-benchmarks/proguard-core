...
class SuperTypeTargetInfoDiffblueTest {
  ...
  @MethodsUnderTest({
    "void proguard.classfile.attribute.annotation.target.SuperTypeTargetInfo.<init>()",
    "void proguard.classfile.attribute.annotation.target.SuperTypeTargetInfo.<init>(byte)",
    "void proguard.classfile.attribute.annotation.target.SuperTypeTargetInfo.<init>(byte, int)"
  })

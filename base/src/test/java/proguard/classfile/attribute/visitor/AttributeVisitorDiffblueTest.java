...
class AttributeVisitorDiffblueTest {
  ...
  @MethodsUnderTest({
    "void proguard.classfile.attribute.visitor.AttributeVisitor.visitAnyAttribute(proguard.classfile.Clazz, proguard.classfile.attribute.Attribute)"
  })
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
    "void proguard.classfile.attribute.visitor.AttributeVisitor.visitCodeAttribute(proguard.classfile.Clazz, proguard.classfile.Method, proguard.classfile.attribute.CodeAttribute)"
  })

...
class ArrayIndexOutOfBoundsDiffblueTest {
  ...
  @MethodsUnderTest({"void proguard.evaluation.exception.ArrayIndexOutOfBounds.<init>(int, int)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
    "int proguard.evaluation.exception.ArrayIndexOutOfBounds.getBound()",
    "int proguard.evaluation.exception.ArrayIndexOutOfBounds.getIndex()"
  })

...
class ConvertedLongValueDiffblueTest {
  ...
  @MethodsUnderTest({
    "void proguard.evaluation.value.ConvertedLongValue.<init>(proguard.evaluation.value.Value)",
    "java.lang.String proguard.evaluation.value.ConvertedLongValue.toString()"
  })
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
    "boolean proguard.evaluation.value.ConvertedLongValue.equals(java.lang.Object)",
    "int proguard.evaluation.value.ConvertedLongValue.hashCode()"
  })

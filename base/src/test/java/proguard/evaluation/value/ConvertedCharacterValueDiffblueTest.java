...
class ConvertedCharacterValueDiffblueTest {
  ...
  @MethodsUnderTest({
    "void proguard.evaluation.value.ConvertedCharacterValue.<init>(proguard.evaluation.value.IntegerValue)",
    "java.lang.String proguard.evaluation.value.ConvertedCharacterValue.toString()"
  })
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
    "boolean proguard.evaluation.value.ConvertedCharacterValue.equals(java.lang.Object)",
    "int proguard.evaluation.value.ConvertedCharacterValue.hashCode()"
  })

...
class CompositeLongValueDiffblueTest {
  ...
  @MethodsUnderTest({
    "void proguard.evaluation.value.CompositeLongValue.<init>(proguard.evaluation.value.LongValue, byte, proguard.evaluation.value.Value)",
    "java.lang.String proguard.evaluation.value.CompositeLongValue.toString()"
  })
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
    "boolean proguard.evaluation.value.CompositeLongValue.equals(java.lang.Object)",
    "int proguard.evaluation.value.CompositeLongValue.hashCode()"
  })

...
class IdentifiedLongValueDiffblueTest {
  ...
  @MethodsUnderTest({
    "void proguard.evaluation.value.IdentifiedLongValue.<init>(proguard.evaluation.value.ValueFactory, int)",
    "java.lang.String proguard.evaluation.value.IdentifiedLongValue.toString()"
  })
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
    "boolean proguard.evaluation.value.IdentifiedLongValue.equals(java.lang.Object)",
    "int proguard.evaluation.value.IdentifiedLongValue.hashCode()"
  })

...
class ConvertedDoubleValueDiffblueTest {
  ...
  @MethodsUnderTest({
    "void proguard.evaluation.value.ConvertedDoubleValue.<init>(proguard.evaluation.value.Value)",
    "java.lang.String proguard.evaluation.value.ConvertedDoubleValue.toString()"
  })
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
    "boolean proguard.evaluation.value.ConvertedDoubleValue.equals(java.lang.Object)",
    "int proguard.evaluation.value.ConvertedDoubleValue.hashCode()"
  })

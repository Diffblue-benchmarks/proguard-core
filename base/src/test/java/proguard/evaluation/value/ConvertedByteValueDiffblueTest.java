...
class ConvertedByteValueDiffblueTest {
  ...
  @MethodsUnderTest({
    "void proguard.evaluation.value.ConvertedByteValue.<init>(proguard.evaluation.value.IntegerValue)",
    "java.lang.String proguard.evaluation.value.ConvertedByteValue.toString()"
  })
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
    "boolean proguard.evaluation.value.ConvertedByteValue.equals(java.lang.Object)",
    "int proguard.evaluation.value.ConvertedByteValue.hashCode()"
  })

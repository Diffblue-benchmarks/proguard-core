...
class CompositeDoubleValueDiffblueTest {
  ...
  @MethodsUnderTest({
    "void proguard.evaluation.value.CompositeDoubleValue.<init>(proguard.evaluation.value.DoubleValue, byte, proguard.evaluation.value.DoubleValue)",
    "java.lang.String proguard.evaluation.value.CompositeDoubleValue.toString()"
  })
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
    "boolean proguard.evaluation.value.CompositeDoubleValue.equals(java.lang.Object)",
    "int proguard.evaluation.value.CompositeDoubleValue.hashCode()"
  })

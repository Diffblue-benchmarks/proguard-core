...
class IdentifiedIntegerValueDiffblueTest {
  ...
  @MethodsUnderTest({
    "void proguard.evaluation.value.IdentifiedIntegerValue.<init>(proguard.evaluation.value.ValueFactory, int)",
    "java.lang.String proguard.evaluation.value.IdentifiedIntegerValue.toString()"
  })
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
    "boolean proguard.evaluation.value.IdentifiedIntegerValue.equals(java.lang.Object)",
    "int proguard.evaluation.value.IdentifiedIntegerValue.hashCode()"
  })

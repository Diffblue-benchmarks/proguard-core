...
class PartialEvaluatorStateTrackerDiffblueTest {
  ...
  @MethodsUnderTest({
    "void proguard.evaluation.util.PartialEvaluatorStateTracker.startCodeAttribute(proguard.classfile.Clazz, proguard.classfile.Method, proguard.classfile.attribute.CodeAttribute, proguard.evaluation.Variables)"
  })

...
class InstructionRecordDiffblueTest {
  ...
  @MethodsUnderTest({
    "void proguard.evaluation.util.jsonprinter.InstructionRecord.<init>(int, java.lang.String)",
    "java.util.List proguard.evaluation.util.jsonprinter.InstructionRecord.getFinalOriginInstructions()",
    "java.util.List proguard.evaluation.util.jsonprinter.InstructionRecord.getFinalStackBefore()",
    "java.util.List proguard.evaluation.util.jsonprinter.InstructionRecord.getFinalTargetInstructions()",
    "java.util.List proguard.evaluation.util.jsonprinter.InstructionRecord.getFinalVariablesBefore()",
    "java.lang.String proguard.evaluation.util.jsonprinter.InstructionRecord.getInstruction()",
    "int proguard.evaluation.util.jsonprinter.InstructionRecord.getOffset()",
    "void proguard.evaluation.util.jsonprinter.InstructionRecord.setFinalOriginInstructions(java.util.List)",
    "void proguard.evaluation.util.jsonprinter.InstructionRecord.setFinalStackBefore(java.util.List)",
    "void proguard.evaluation.util.jsonprinter.InstructionRecord.setFinalTargetInstructions(java.util.List)",
    "void proguard.evaluation.util.jsonprinter.InstructionRecord.setFinalVariablesBefore(java.util.List)"
  })
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
    "java.lang.StringBuilder proguard.evaluation.util.jsonprinter.InstructionRecord.toJson(java.lang.StringBuilder)"
  })
  void testToJson() {
    // Arrange

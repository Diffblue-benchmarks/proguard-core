...
class BranchTargetRecordDiffblueTest {
  ...
  void testToJson() {
    ...
    // Assert
    assertEquals(
        "Str{\"startOffset\":1,\"startStack\":[],\"startVariables\":[]}", builder.toString());
  ...
  @Test
  @DisplayName(
      "Test toJson(StringBuilder); given ArrayList() add 'Variables'; then StringBuilder(String) with 'Str' toString is a string")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"StringBuilder BranchTargetRecord.toJson(StringBuilder)"})
  void testToJson_givenArrayListAddVariables_thenStringBuilderWithStrToStringIsAString() {
    // Arrange
    ArrayList<String> variables = new ArrayList<>();
    ...
    // Assert
    assertEquals(
        "Str{\"startOffset\":1,\"startStack\":[\"Stack\",\"Stack\",\"Stack\",\"Stack\",\"Stack\",\"Stack\",\"Stack\",\"Stack\","
